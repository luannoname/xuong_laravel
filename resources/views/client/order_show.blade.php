    ...
    <div class="container">
        <form action="" method="post">
            <div class="cart-main-area">
                <div class="container">
                    <h3 class="cart-page-title">Thông tin đơn hàng</h3>
                    <div class="row">
                                            ...
                                            @endphp
                                                <tr>
                                                    ...
                                                    <td class="product-price">
                                                        {{ number_format($item->product_price_sale ?: $item->product_price, 0, '', '.') }} vnđ
                                                    </td>
                                                    ...
                                                    <td class="product-subtotal">
                                                        {{ number_format($item->quantity * $item->product_price_sale ?: $item->product_price, 0, '', '.') }} vnđ
                                                    </td>
                                                </tr>
                                            @endforeach
                                            <td colspan="5"><b>Tổng tiền</b></td>
                                            <td><b>{{ number_format($order->total_price, 0, '', '.') }} vnđ</b></td>
                                        </tbody>
                                    </table>
                                </div>
                                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="billing-info mb-20px">
                                    <label>Họ tên</label>
                                    <input readonly type="text" name="user_name" value="{{ $order->user_name }}"/>
                                    @error('user_name')
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="billing-info mb-20px">
                                    ...
                                    <input readonly type="text" name="user_phone" value="{{ $order->user_phone }}"/>
                                    @error('user_phone')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="billing-info mb-20px">
                                    <label>Email</label>
                                    <input readonly type="text" name="user_email" value="{{ $order->user_email }}"/>
                                    @error('user_email')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="billing-info mb-20px">
                                    <label>Địa chỉ</label>
                                    <input readonly type="text" name="user_address" value="{{ $order->user_address }}"/>
                                    @error('user_address')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                ...
                <div class="billing-info-wrap">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="billing-info mb-20px">
                                <label>Họ tên</label>
                                <input readonly type="text" name="receiver_name" value="{{ $order->receiver_name }}"/>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="billing-info mb-20px">
                                <label>Số điện thoại</label>
                                <input readonly type="text" name="receiver_phone" value="{{ $order->receiver_phone }}"/>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="billing-info mb-20px">
                                <label>Email</label>
                                <input readonly type="text" name="receiver_email" value="{{ $order->receiver_email }}"/>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="billing-info mb-20px">
                                <label>Địa chỉ</label>
                                <input readonly type="text" name="receiver_address" value="{{ $order->receiver_address }}"/>
                            </div>
                        </div>
                    </div>
                </div>
